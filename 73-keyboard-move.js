window.addEventListener("load", function () {
  ...
  //스타일의 값을 받아올때 사용함
  //단 조건이 스크립트에서 값을 설정할 경우만
  // console.log(icon.style.cssText)
  //defaultView ->window
  //getComputedStyle("선택자") css값을 가지 있는 대상
  //getPropertyValue("속성") ->
//   console.log(
//     document.defaultView.getComputedStyle(icon).getPropertyValue("left")
//   );

  //문서에서 키보드를 누르면 현재 눌러지 키에 대한 정보를
  //받아서 화살표 위를 누르면 아이콘이 위로 10pixel씩 이동
  //아래를 누르면 10pixel씩 아래로 이동
  //오른쪽 10pixel씩 오른쪽으로 이동
  //왼쪽 10pixel씩 왼쪽으로 이동
